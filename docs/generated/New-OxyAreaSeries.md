...
## DESCRIPTION
Returns an OxyPlot.Series.AreaSeries object that   Represents an area series that fills the polygon defined by two sets of points or one set of points and a constant.
