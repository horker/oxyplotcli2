...
### -OutlierOutline
Sets the a custom polygon outline for the outlier markers.
Set OxyPlot.Series.BoxPlotSeries.OutlierType to OxyPlot.MarkerType.Custom to use this property.
