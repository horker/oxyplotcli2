...
## SYNOPSIS
Returns an object that   Represents a two-color area series.

## SYNTAX

```
New-OxyTwoColorAreaSeries [-InputObject <PSObject>] [-X1Name <String>] [-Y1Name <String>] [-X2Name <String>]
 ...
 [-SvgIsDocument] [-PassThru] [-Style <String>] [-AsUIElement] [-Show] [-ReuseWindow] [-Fill2 <OxyColor>]
 [-Dashes2 <Double[]>] [-LineStyle2 <LineStyle>] [-MarkerFill2 <OxyColor>] [-MarkerStroke2 <OxyColor>]
 [-Limit <Double>] [-ConstantY2 <Double>] [-DataFieldX2 <String>] [-DataFieldY2 <String>] [-Color2 <OxyColor>]
 [-Fill <OxyColor>] [-Reverse2 <Bool>] [-Color <OxyColor>] [-BrokenLineColor <OxyColor>]
 [-BrokenLineStyle <LineStyle>] [-BrokenLineThickness <Double>] [-Dashes <Double[]>]
...
## DESCRIPTION
Returns an OxyPlot.Series.TwoColorAreaSeries object that   Represents a two-color area series.
...
### -Color2
Sets the color of the line for the second data set.
...
### -ConstantY2
Sets a constant value for the area definition. 
This is used if DataFieldBase and BaselineValues are null.

ConstantY2 is used if ItemsSource is set   and DataFieldX2 or DataFieldY2 are null,   or if ItemsSource is null and Points2 is empty.
...
### -DataFieldX2
Sets the data field to use for the X-coordinates of the second data set.

This property is used if ItemsSource is set.
...
### -DataFieldY2
Sets the data field to use for the Y-coordinates of the second data set.
...
### -Fill2
Sets the area fill color below the limit line.
...
### -Limit
Sets a baseline for the series.
...
### -MarkerFill2
Sets the marker fill color which is below the limit line.
The default is OxyPlot.OxyColors.Automatic.
...
### -MarkerStroke2
Sets the marker stroke which is below the limit line.
The default is OxyColors.Automatic.
...
### -Reverse2
Sets a value indicating whether the second data collection should be reversed.

The first dataset is not reversed, and normally  the second dataset should be reversed to get a  closed polygon.
...
### Horker.OxyPlotCli.SeriesInfo`1[[OxyPlot.Series.TwoColorAreaSeries, OxyPlot, Version=2.0.0.0, Culture=neutral, PublicKeyToken=638079a8f0bd61e9]]
## NOTES
