...
The StringFormat value can be used to force formatting of the axis values  "yyyy-MM-dd" shows date  "w" or "ww" shows week number  "h:mm" shows hours and minutes
...
## DESCRIPTION
Returns an OxyPlot.Axes.DateTimeAxis object that   Represents an axis presenting System.DateTime values.
