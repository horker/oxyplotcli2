...
## SYNOPSIS
Returns an object that   Represents a "higher performance" ordered OHLC series for candlestick charts

Does the following:  - automatically calculates the appropriate bar width based on available screen + # of bars  - can render and pan within millions of bars, using a fast approach to indexing in series  - convenience methods

This implementation is associated with issue 369 (https://github.com/oxyplot/oxyplot/issues/369).

See also Wikipedia (http://en.wikipedia.org/wiki/Candlestick_chart)and Matlab documentation (http://www.mathworks.com/help/toolbox/finance/candle.html).

## SYNTAX

```
New-OxyCandleStickSeries [-InputObject <PSObject>] [-XName <String>] [-HighName <String>] [-LowName <String>]
 [-OpenName <String>] [-CloseName <String>] [-GroupName <String>] [-X <Double[]>] [-High <Double[]>]
 [-Low <Double[]>] [-Open <Double[]>] [-Close <Double[]>] [-Group <Object[]>] [-AddTo <PlotModel>]
 [-OutFile <String>] [-OutWidth <Int32>] [-OutHeight <Int32>] [-SvgIsDocument] [-PassThru] [-Style <String>]
 [-AsUIElement] [-Show] [-ReuseWindow] [-IncreasingColor <OxyColor>] [-DecreasingColor <OxyColor>]
 [-CandleWidth <Double>] [-Color <OxyColor>] [-Dashes <Double[]>] [-DataFieldClose <String>]
 [-DataFieldHigh <String>] [-DataFieldLow <String>] [-DataFieldOpen <String>] [-DataFieldX <String>]
 [-LineJoin <LineJoin>] [-LineStyle <LineStyle>]
 [-Mapping <System.Func`2[System.Object,OxyPlot.Series.HighLowItem]>] [-StrokeThickness <Double>]
 [-TickLength <Double>] [-XAxisKey <String>] [-YAxisKey <String>] [-ItemsSource <IEnumerable>]
 ...
 [-SelectionMode <SelectionMode>] [-AxType <String>] [-AxStartAngle <Double>] [-AxEndAngle <Double>]
 ...
 [-AxClipTitle <Bool>] [-AxCropGridlines <Bool>] [-AxEndPosition <Double>] [-AxExtraGridlineColor <OxyColor>]
...
## DESCRIPTION
Returns an OxyPlot.Series.CandleStickSeries object that   Represents a "higher performance" ordered OHLC series for candlestick charts
...
### -CandleWidth
Sets the bar width in data units (for example if the X axis is date/time based, then should  use the difference of DateTimeAxis.ToDouble(date) to indicate the width).
By default candlestick  series will use 0.80 x the minimum difference in data points.
...
### -DecreasingColor
Sets the fill color used when the closing value is less than opening value.
...
### -IncreasingColor
Sets the color used when the closing value is greater than opening value.
...
```yaml
Type: System.Func`2[System.Object,OxyPlot.Series.HighLowItem]
Parameter Sets: (All)
Aliases:
...
### Horker.OxyPlotCli.SeriesInfo`1[[OxyPlot.Series.CandleStickSeries, OxyPlot, Version=2.0.0.0, Culture=neutral, PublicKeyToken=638079a8f0bd61e9]]
## NOTES
...
[http://www.mathworks.com/help/toolbox/finance/candle.html](http://www.mathworks.com/help/toolbox/finance/candle.html)
