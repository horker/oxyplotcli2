...
```
New-OxyVolumeSeries [-InputObject <PSObject>] [-XName <String>] [-OpenName <String>] [-HighName <String>]
 [-LowName <String>] [-CloseName <String>] [-BuyVolumeName <String>] [-SellVolumeName <String>]
 [-GroupName <String>] [-X <Double[]>] [-Open <Double[]>] [-High <Double[]>] [-Low <Double[]>]
 [-Close <Double[]>] [-BuyVolume <Double[]>] [-SellVolume <Double[]>] [-Group <Object[]>] [-AddTo <PlotModel>]
 [-OutFile <String>] [-OutWidth <Int32>] [-OutHeight <Int32>] [-SvgIsDocument] [-PassThru] [-Style <String>]
 [-AsUIElement] [-Show] [-ReuseWindow] [-Items <System.Collections.Generic.List`1[OxyPlot.Series.OhlcvItem]>]
 [-VolumeStyle <VolumeStyle>] [-StrokeThickness <Double>] [-StrokeIntensity <Double>]
 [-PositiveColor <OxyColor>] [-NegativeColor <OxyColor>] [-InterceptColor <OxyColor>]
 [-InterceptStrokeThickness <Double>] [-InterceptLineStyle <LineStyle>] [-PositiveHollow <Bool>]
 [-NegativeHollow <Bool>] [-BarWidth <Double>] [-XAxisKey <String>] [-YAxisKey <String>]
...
### -NegativeColor
Sets the fill color used when the closing value is less than opening value or  for selling volume
...
### -PositiveColor
Sets the color used when the closing value is greater than opening value or  for buying volume.
...
### Horker.OxyPlotCli.SeriesInfo`1[[OxyPlot.Series.VolumeSeries, OxyPlot, Version=2.0.0.0, Culture=neutral, PublicKeyToken=638079a8f0bd61e9]]
## NOTES
