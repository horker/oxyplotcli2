...
## SYNOPSIS
Returns an object that   Represents an annotation that shows text.

## SYNTAX

```
New-OxyTextAnnotation [-Background <OxyColor>] [-Offset <Double[]>] [-Padding <Double[]>] [-Stroke <OxyColor>]
...
## DESCRIPTION
Returns an OxyPlot.Annotations.TextAnnotation object that   Represents an annotation that shows text.
