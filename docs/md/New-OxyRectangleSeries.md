...
New-OxyRectangleSeries [-InputObject <PSObject>] [-X1Name <String>] [-X2Name <String>] [-Y1Name <String>]
 ...
 [-AsUIElement] [-Show] [-ReuseWindow] [-ColorAxisKey <String>] [-LabelFormatString <String>]
 ...
 [-ToolTip <String>] [-Selectable <Bool>] [-SelectionMode <SelectionMode>]
 [-AxType <String>] [-AxStartAngle <Double>] [-AxEndAngle <Double>] [-AxFormatAsFractions <Bool>] [-AxFractionUnit <Double>]
