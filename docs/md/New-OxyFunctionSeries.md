...
Returns an object that represents a line series that generates its dataset from a function.
 
Define f(x) and make a plot on the range [x0,x1] or define x(t) and y(t) and make a plot on the range [t0,t1].
...
### Explicit
```
New-OxyFunctionSeries -F <ScriptBlock[]> [-X0 <Double>] [-X1 <Double>] [-N <Double>] [-Dx <Double>]
 [-AddTo <PlotModel>] [-OutFile <String>] [-OutWidth <Int32>] [-OutHeight <Int32>] [-SvgIsDocument] [-PassThru]
 [-Style <String>] [-AsUIElement] [-Show] [-ReuseWindow] [-Color <OxyColor>] [-BrokenLineColor <OxyColor>]
...
### Implicit
```
New-OxyFunctionSeries -Fx <ScriptBlock[]> -Fy <ScriptBlock[]> [-T0 <Double>] [-T1 <Double>] [-N <Double>]
 [-Dx <Double>] [-AddTo <PlotModel>] [-OutFile <String>] [-OutWidth <Int32>] [-OutHeight <Int32>]
 [-SvgIsDocument] [-PassThru] [-Style <String>] [-AsUIElement] [-Show] [-ReuseWindow] [-Color <OxyColor>]
 [-BrokenLineColor <OxyColor>] [-BrokenLineStyle <LineStyle>] [-BrokenLineThickness <Double>]
 [-Dashes <Double[]>]
 [-Decimator <System.Action`2[System.Collections.Generic.List`1[OxyPlot.ScreenPoint],System.Collections.Generic.List`1[OxyPlot.ScreenPoint]]>]
 [-LabelFormatString <String>] [-LabelMargin <Double>] [-LineJoin <LineJoin>] [-LineStyle <LineStyle>]
 [-LineLegendPosition <LineLegendPosition>] [-MarkerFill <OxyColor>] [-MarkerOutline <Double[]>]
...
Returns an OxyPlot.Series.FunctionSeries object that represents a line series that generates its dataset from a function.
...
```yaml
Type: Horker.OxyPlotCli.TypeAdaptors.ScriptBlock[]
