...
online version: https://github.com/horker/oxyplotcli2/blob/master/docs/cmdlets/New-OxyCategoryAxis.md
schema: 2.0.0
---
...
```
New-OxyCategoryAxis [-GapWidth <Double>] [-IsTickCentered <Bool>] [-ItemsSource <IEnumerable>]
 [-LabelField <String>] [-FormatAsFractions <Bool>] [-FractionUnit <Double>] [-FractionUnitSymbol <String>]
