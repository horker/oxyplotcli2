...
online version: https://github.com/horker/oxyplotcli2/blob/master/docs/cmdlets/New-OxyTornadoBarSeries.md
schema: 2.0.0
---
...
```
New-OxyTornadoBarSeries [-InputObject <PSObject>] [-MinimumName <String>] [-MaximumName <String>]
 [-BarBaseValueName <String>] [-MinimumColorName <String>] [-MaximumColorName <String>]
 [-CategoryName <String>] [-GroupName <String>] [-Minimum <Double[]>] [-Maximum <Double[]>]
 [-BarBaseValue <Double[]>] [-MinimumColor <OxyColor[]>] [-MaximumColor <OxyColor[]>] [-Category <Category[]>]
 [-Group <Object[]>] [-AddTo <PlotModel>] [-OutFile <String>] [-OutWidth <Int32>] [-OutHeight <Int32>]
 [-SvgIsDocument] [-PassThru] [-Style <String>] [-AsPlotView] [-Show] [-ReuseWindow] [-BarWidth <Double>]
 [-BaseValue <Double>] [-LabelColor <OxyColor>] [-LabelField <String>] [-LabelMargin <Double>]
 [-MaximumField <String>] [-MaximumFillColor <OxyColor>] [-MaximumLabelFormatString <String>]
 [-MinimumField <String>] [-MinimumFillColor <OxyColor>] [-MinimumLabelFormatString <String>]
...
Specifies the sequence of the element BarBaseValue of the data point.
...
Specifies the sequence of the element Maximum of the data point.
...
Specifies the sequence of the element MaximumColor of the data point.
...
Specifies the sequence of the element Minimum of the data point.
...
Specifies the sequence of the element MinimumColor of the data point.
...
### Horker.OxyPlotCli.SeriesInfo`1[[OxyPlot.Series.TornadoBarSeries, OxyPlot, Version=2.0.0.0, Culture=neutral, PublicKeyToken=638079a8f0bd61e9]]
## NOTES
