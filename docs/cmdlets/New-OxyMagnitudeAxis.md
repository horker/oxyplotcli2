...
online version: https://github.com/horker/oxyplotcli2/blob/master/docs/cmdlets/New-OxyMagnitudeAxis.md
schema: 2.0.0
---
...
Returns an object that represents a magnitude axis for polar plots.
...
```
New-OxyMagnitudeAxis [-FormatAsFractions <Bool>] [-FractionUnit <Double>] [-FractionUnitSymbol <String>]
