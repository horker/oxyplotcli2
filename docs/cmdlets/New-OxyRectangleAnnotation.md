...
online version: https://github.com/horker/oxyplotcli2/blob/master/docs/cmdlets/New-OxyRectangleAnnotation.md
schema: 2.0.0
---
...
```
New-OxyRectangleAnnotation [-MinimumX <Double>] [-MaximumX <Double>] [-MinimumY <Double>] [-MaximumY <Double>]
 [-ClipByXAxis <Bool>] [-ClipByYAxis <Bool>] [-Fill <OxyColor>] [-Stroke <OxyColor>]
