...
online version: https://github.com/horker/oxyplotcli2/blob/master/docs/cmdlets/New-OxyFunctionSeries.md
schema: 2.0.0
---
...
New-OxyFunctionSeries -F <ScriptBlock[]> [-X0 <Double>] [-X1 <Double>] [-N <Double>] [-Dx <Double>]
 ...
 [-Style <String>] [-AsPlotView] [-Show] [-ReuseWindow] [-Color <OxyColor>] [-BrokenLineColor <OxyColor>]
...
New-OxyFunctionSeries -Fx <ScriptBlock[]> -Fy <ScriptBlock[]> [-T0 <Double>] [-T1 <Double>] [-N <Double>]
 ...
 [-SvgIsDocument] [-PassThru] [-Style <String>] [-AsPlotView] [-Show] [-ReuseWindow] [-Color <OxyColor>]
