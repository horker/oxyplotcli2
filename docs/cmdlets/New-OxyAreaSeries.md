...
online version: https://github.com/horker/oxyplotcli2/blob/master/docs/cmdlets/New-OxyAreaSeries.md
schema: 2.0.0
---
...
New-OxyAreaSeries [-InputObject <PSObject>] [-X1Name <String>] [-Y1Name <String>] [-X2Name <String>]
 ...
 [-SvgIsDocument] [-PassThru] [-Style <String>] [-AsPlotView] [-Show] [-ReuseWindow] [-ConstantY2 <Double>]
