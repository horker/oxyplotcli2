...
online version: https://github.com/horker/oxyplotcli2/blob/master/docs/cmdlets/New-OxyBoxPlotSeries.md
schema: 2.0.0
---
...
New-OxyBoxPlotSeries [-InputObject <PSObject>] [-CategoryName <String>] [-LowerWhiskerName <String>]
 ...
 [-AsPlotView] [-Show] [-ReuseWindow] [-BoxWidth <Double>] [-Fill <OxyColor>]
 ...
 [-OutlierOutline <Double[]>] [-ShowBox <Bool>] [-ShowMedianAsDot <Bool>] [-ShowMeanAsDot <Bool>]
 [-Stroke <OxyColor>] [-StrokeThickness <Double>] [-WhiskerWidth <Double>] [-XAxisKey <String>]
...
Specifies the sequence of the element BoxBottom of the data point.
...
Specifies the sequence of the element BoxTop of the data point.
...
```yaml
Type: System.Collections.Generic.IList`1[OxyPlot.Series.BoxPlotItem]
Parameter Sets: (All)
Aliases:
...
Specifies the sequence of the element LowerWhisker of the data point.
...
Specifies the sequence of the element Median of the data point.
...
Specifies the sequence of the element Outliers of the data point.
...
Specifies the sequence of the element UpperWhisker of the data point.
...
### Horker.OxyPlotCli.SeriesInfo`1[[OxyPlot.Series.BoxPlotSeries, OxyPlot, Version=2.0.0.0, Culture=neutral, PublicKeyToken=638079a8f0bd61e9]]
## NOTES
