...
online version: https://github.com/horker/oxyplotcli2/blob/master/docs/cmdlets/New-OxyCandleStickSeries.md
schema: 2.0.0
---
...
New-OxyCandleStickSeries [-InputObject <PSObject>] [-XName <String>] [-HighName <String>] [-LowName <String>]
 ...
 [-AsPlotView] [-Show] [-ReuseWindow] [-IncreasingColor <OxyColor>] [-DecreasingColor <OxyColor>]
