...
online version: https://github.com/horker/oxyplotcli2/blob/master/docs/cmdlets/New-OxyTwoColorAreaSeries.md
schema: 2.0.0
---
...
New-OxyTwoColorAreaSeries [-InputObject <PSObject>] [-X1Name <String>] [-Y1Name <String>] [-X2Name <String>]
 ...
 [-SvgIsDocument] [-PassThru] [-Style <String>] [-AsPlotView] [-Show] [-ReuseWindow] [-Fill2 <OxyColor>]
...
ConstantY2 is used if ItemsSource is set 
 and DataFieldX2 or DataFieldY2 are null, 
 or if ItemsSource is null and Points2 is empty.
...
Sets the marker fill color which is below the limit line. The default is OxyPlot.OxyColors.Automatic.
...
Sets the marker stroke which is below the limit line. The default is OxyColors.Automatic.
