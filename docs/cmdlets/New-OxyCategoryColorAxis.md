...
online version: https://github.com/horker/oxyplotcli2/blob/master/docs/cmdlets/New-OxyCategoryColorAxis.md
schema: 2.0.0
---
...
```
New-OxyCategoryColorAxis [-InvalidCategoryColor <OxyColor>] [-Palette <OxyPaletteItem[]>] [-GapWidth <Double>]
 [-IsTickCentered <Bool>] [-ItemsSource <IEnumerable>] [-LabelField <String>] [-FormatAsFractions <Bool>]
