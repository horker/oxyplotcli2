...
online version: https://github.com/horker/oxyplotcli2/blob/master/docs/cmdlets/New-OxyDateTimeAxis.md
schema: 2.0.0
---
...
Sets the time zone (used when formatting date/time values).
