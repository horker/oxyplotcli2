...
online version: https://github.com/horker/oxyplotcli2/blob/master/docs/cmdlets/New-OxyHighLowSeries.md
schema: 2.0.0
---
...
```
New-OxyHighLowSeries [-InputObject <PSObject>] [-XName <String>] [-HighName <String>] [-LowName <String>]
 ...
 [-AsPlotView] [-Show] [-ReuseWindow] [-Color <OxyColor>] [-Dashes <Double[]>] [-DataFieldClose <String>]
...
### Horker.OxyPlotCli.SeriesInfo`1[[OxyPlot.Series.HighLowSeries, OxyPlot, Version=2.0.0.0, Culture=neutral, PublicKeyToken=638079a8f0bd61e9]]
## NOTES
