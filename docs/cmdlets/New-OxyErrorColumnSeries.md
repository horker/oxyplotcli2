...
online version: https://github.com/horker/oxyplotcli2/blob/master/docs/cmdlets/New-OxyErrorColumnSeries.md
schema: 2.0.0
---
...
New-OxyErrorColumnSeries [-InputObject <PSObject>] [-ValueName <String>] [-ErrorName <String>]
 ...
 [-OutHeight <Int32>] [-SvgIsDocument] [-PassThru] [-Style <String>] [-AsPlotView] [-Show] [-ReuseWindow]
...
Specifies the property name of the input object to be processed as the element Error of the data point.
